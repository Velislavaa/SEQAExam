...
class AppDynamicsJob(unittest.TestCase):
    ...
    def test_app_dynamics_job(self):
        ...
        driver.find_element_by_id("UserLoginForm_username").send_keys("1815006")
        driver.find_element_by_id("login-content").click()
        driver.find_element_by_id("UserLoginForm_password").click()
        driver.find_element_by_id("UserLoginForm_password").clear()
        driver.find_element_by_id("UserLoginForm_password").send_keys("limonada99")
